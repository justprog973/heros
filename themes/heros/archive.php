<?php get_header(); ?>
    <header class="header-archive w-full flex bg-gray-600">
        <div class="jp-container !py-0">
            <div class="header-archive__container flex justify-center flex-col gap-1 w-full h-[150px] md:h-[250px]">
    ...
    <div class="jp-container gap-10 grid grid-flow-row lg:grid-cols-12 sm:grid-cols-1">
        <div class="max-w-7xl w-full mx-auto <?php if (is_active_sidebar('primary-sidebar')): echo "lg:col-span-9 md:col-span-12"; else: echo "col-span-12"; endif; ?>">
            <div class="grid lg:grid-cols-3 lg:gap-10 gap-2 md:gap-5 md:grid-cols-2 grid-cols-2">
